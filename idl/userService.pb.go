...
var file_userService_proto_goTypes = []interface{}{
	(*UserRequest)(nil),        // 0: idl.UserRequest
	(*UserDetailResponse)(nil), // 1: idl.UserDetailResponse
	(*UserModel)(nil),          // 2: idl.UserModel
}
var file_userService_proto_depIdxs = []int32{
	2, // 0: idl.UserDetailResponse.UserDetail:type_name -> idl.UserModel
	0, // 1: idl.UserService.UserLogin:input_type -> idl.UserRequest
	0, // 2: idl.UserService.UserRegister:input_type -> idl.UserRequest
	1, // 3: idl.UserService.UserLogin:output_type -> idl.UserDetailResponse
	1, // 4: idl.UserService.UserRegister:output_type -> idl.UserDetailResponse
