...
var file_taskService_proto_goTypes = []interface{}{
	(*TaskRequest)(nil),        // 0: idl.TaskRequest
	(*TaskListResponse)(nil),   // 1: idl.TaskListResponse
	(*TaskDetailResponse)(nil), // 2: idl.TaskDetailResponse
	(*TaskModel)(nil),          // 3: idl.TaskModel
}
var file_taskService_proto_depIdxs = []int32{
	3, // 0: idl.TaskListResponse.TaskList:type_name -> idl.TaskModel
	3, // 1: idl.TaskDetailResponse.TaskDetail:type_name -> idl.TaskModel
	0, // 2: idl.TaskService.CreateTask:input_type -> idl.TaskRequest
	0, // 3: idl.TaskService.GetTasksList:input_type -> idl.TaskRequest
	0, // 4: idl.TaskService.GetTask:input_type -> idl.TaskRequest
	0, // 5: idl.TaskService.UpdateTask:input_type -> idl.TaskRequest
	0, // 6: idl.TaskService.DeleteTask:input_type -> idl.TaskRequest
	2, // 7: idl.TaskService.CreateTask:output_type -> idl.TaskDetailResponse
	1, // 8: idl.TaskService.GetTasksList:output_type -> idl.TaskListResponse
	2, // 9: idl.TaskService.GetTask:output_type -> idl.TaskDetailResponse
	2, // 10: idl.TaskService.UpdateTask:output_type -> idl.TaskDetailResponse
	2, // 11: idl.TaskService.DeleteTask:output_type -> idl.TaskDetailResponse
